            ...
            <div className="footerContent">
                <div className="footerSection">
                    ...
                    <div className="socialMedia">
                        <a href="https://www.facebook.com/TechnoTreasureUI" className="socialLink" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faFacebook} /></a>
                        <a href="https://twitter.com/TechnoTreUI" className="socialLink" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faTwitter} /></a>
                        <a href="https://www.instagram.com/technotreasure_/" className="socialLink" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={faInstagram} /></a>
                    </div>
                </div>
